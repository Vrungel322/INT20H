...
import me.kpr.nnp.fragments.SettingsFragment;
            ...
            helper.setListener((a, i) -> {
                ...
                handler.post(() -> {
                    if (i == NfcAdapter.STATE_ON) {
                        // set smth
                        settingsFragment.onChangeSwitch(i);
                        Toast.makeText(getApplicationContext(), "NFC ON", Toast.LENGTH_SHORT).show();
                    } else {
                        // set smth
                        settingsFragment.onChangeSwitch(i);
                        Toast.makeText(getApplicationContext(), "NFC OFF", Toast.LENGTH_SHORT).show();
                    }
                });
            });
        }
